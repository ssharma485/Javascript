 ...
 *      g(4); //=> 10
 */
var curryN = /*#__PURE__*/_curry2.default(function curryN(length, fn) {
  if (length === 1) {
    return _curry1.default(fn);
  }
  return _arity.default(length, _curryN.default(length, [], fn));
});
var curryN$1 = curryN;

exports.default = curryN$1;
